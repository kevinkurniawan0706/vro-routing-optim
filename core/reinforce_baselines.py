...
import copy
from core.train import rollout, get_inner_model
...
class RolloutBaseline(Baseline):
    ...
    def wrap_dataset(self, dataset):
        ...
        # print(f"Before {self.model, dataset, self.opts}")
        # print(f"wrap dataset check baseline {rollout(self.model, dataset, self.opts).view(-1, 1)}")
        # raise ValueError

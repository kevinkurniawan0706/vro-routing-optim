...
def get_options(args=None):
    ...
    parser.add_argument('--n_paths', type=int, default=5, help='number of paths')
    parser.add_argument('--kl-loss', type=float, default=0.0,
                        help='KL regularization weight between multi-decoder path logits (0 disables).')
